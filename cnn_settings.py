...
class Config():
    ##############################################
    ###B: number of training samples in one run
    ###W: the first dimension
    ###H: the second dimension
...
##    train_step = 1400
    ...
    save_path = '/home/kai/04_headcount_in_house/02_cnn/'
...
class NeuralModel():
    def __init__(self, config, name):
        ...
        print('conv1_1_d shape:',conv1_1_d.shape)
        ...
        print('conv1_2_d shape:',conv1_2_d.shape)
        ...
        print('conv2_1_d shape:',conv2_1_d.shape)
        ...
        print('conv2_2_d shape:',conv2_2_d.shape)
        ...
        print('conv3_1_d shape:',conv3_1_d.shape)
        ...
        print('conv3_2_d shape:',conv3_2_d.shape)
        ...
        print('conv3_3_d shape:',conv3_3_d.shape)
        ...
        print('flattened shape:',flattened.get_shape())
        # flattened_d = tf.nn.dropout(flattened, 0.25)

        print ('flattened.get_shape()',flattened.get_shape())
